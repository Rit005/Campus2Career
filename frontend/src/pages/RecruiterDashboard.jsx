        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm text-gray-600">My Company</p>
          ...
          <div className="p-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-center p-4 bg-blue-50 rounded-lg">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">Software Engineer - John Doe applied</p>
                    </div>
                  </div>
                  <div className="flex items-center p-4 bg-green-50 rounded-lg">
                    ...
                    <div className="ml-4">
                      ...
                      <p className="text-sm text-gray-500">Jane Smith - Frontend Developer</p>
                    </div>
                  </div>
                </div>
              </div>
            ...
            {activeTab === 'jobs' && (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">Get started by posting a new job opening.</p>
            ...
            {activeTab === 'company' && (
              <div className="text-center py-12">
                ...
                <p className="mt-1 text-sm text-gray-500">Create a company profile to start attracting talent.</p>
                <button className="mt-4 px-4 py-2 bg-primary-600 text-white rounded-lg hover:bg-primary-700">
